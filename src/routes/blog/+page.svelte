<div class="max-w-3xl mx-auto py-8 px-4">
  ...
  <div class="space-y-6">
    <article class="border border-base-300 rounded-lg p-6 hover:border-base-content/20 transition-colors">
      <a href="/blog/job-assistant" class="block group">
    ...
    <article class="border border-base-300 rounded-lg p-6 hover:border-base-content/20 transition-colors">
      <a href="/blog/diarycard-tech" class="block group">
        <h2 class="text-xl font-semibold mb-2 group-hover:underline">
    ...
    <article class="border border-base-300 rounded-lg p-6 hover:border-base-content/20 transition-colors">
      <a href="/blog/diarycard" class="block group">
        <h2 class="text-xl font-semibold mb-2 group-hover:underline">
